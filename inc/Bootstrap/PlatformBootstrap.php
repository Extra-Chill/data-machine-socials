...
final class PlatformBootstrap {
	...
	private static function platform_providers(): array {
		return array(
			...
			self::provider( 'facebook', 'Facebook', array( 'FacebookPublishAbility', 'FacebookReadAbility', 'FacebookUpdateAbility', 'FacebookDeleteAbility', 'FacebookCommentReplyAbility' ), array( 'datamachine/facebook-publish', 'datamachine/facebook-pages', 'datamachine/facebook-read', 'datamachine/facebook-update', 'datamachine/facebook-delete', 'datamachine/facebook-comment-reply' ), array( 'PublishFacebook', 'ReadFacebook', 'UpdateFacebook', 'DeleteFacebook', 'ReplyFacebookComment' ) ),
			...
			self::provider( 'instagram', 'Instagram', array( 'InstagramPublishAbility', 'InstagramReadAbility', 'InstagramUpdateAbility', 'InstagramDeleteAbility', 'InstagramCommentReplyAbility', 'InstagramMessageSendAbility' ), array( 'datamachine/instagram-publish', 'datamachine/instagram-account', 'datamachine/instagram-read', 'datamachine/instagram-update', 'datamachine/instagram-delete', 'datamachine/instagram-comment-reply', 'datamachine/instagram-message-send' ), array( 'ReadInstagram', 'UpdateInstagram', 'ReplyInstagramComment', 'PublishInstagram', 'PublishReelInstagram', 'PublishStoryInstagram', 'DeleteInstagram', 'ReadInstagramMessages', 'SendInstagramMessage' ) ),
