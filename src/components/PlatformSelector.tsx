...
export function PlatformSelector( {
	...
	const constraints =
		selected.length > 0 ? getCombinedConstraints( selected ) : null;
		...
		<div className="dms-platform-selector">
			...
			<div className="dms-platform-list">
				{ Object.entries( platforms ).map(
					( [ slug, config ]: [ string, PlatformConfig ] ) => {
							...
							>
								...
								<div className="dms-platform-details">
									...
									<span className="dms-platform-limit">
										{ config.charLimit.toLocaleString() }{ ' ' }
										{ __(
											'chars',
											'data-machine-socials'
										) }
			...
			{ constraints && (
				<div className="dms-constraints-notice">
					<h5>
						{ __( 'Combined Constraints', 'data-machine-socials' ) }
					</h5>
					<ul>
						<li>
							{ __( 'Max images:', 'data-machine-socials' ) }{ ' ' }
							{ constraints.maxImages }
						</li>
						<li>
							{ __( 'Character limit:', 'data-machine-socials' ) }{ ' ' }
							{ constraints.charLimit.toLocaleString() }
						</li>
